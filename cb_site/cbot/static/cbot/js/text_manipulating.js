...
export var TypingFunctionalities;
(function (TypingFunctionalities) {
    // typing styles, used to determine the appropriate methods in class text typer
    let TypingStyles;
    (function (TypingStyles) {
        TypingStyles[TypingStyles["BY_LETTER"] = 0] = "BY_LETTER";
        TypingStyles[TypingStyles["BY_WORD"] = 1] = "BY_WORD";
    })(TypingStyles = TypingFunctionalities.TypingStyles || (TypingFunctionalities.TypingStyles = {}));
    // determines the queue state of a promise chain
    let QueueState;
    (function (QueueState) {
        QueueState[QueueState["ADDING"] = 0] = "ADDING";
        QueueState[QueueState["FINISHING"] = 1] = "FINISHING";
        QueueState[QueueState["QUITTING"] = 2] = "QUITTING"; // signifies an abrupt exit of the current queue
    })(QueueState = TypingFunctionalities.QueueState || (TypingFunctionalities.QueueState = {}));
    ...
    class TextTyper {
        ...
        type(htmlElem, targetText, typeStyle, pauseTimeMS) {
            switch (typeStyle) {
        ...
        async typeTextByLetter(htmlElem, targetText, pauseTimeMS) {
            ...
            for (const char of charArray) {
                ...
                await new Promise((res) => { setTimeout(res, (pauseTimeMS) / arrLength); });
            }
            ;
        }
        // typing text by word version (this one is suitable for gemini chunk streams)
        async typeTextByWord(htmlElem, targetText, pauseTimeMS) {
    ...
    TypingFunctionalities.TextTyper = TextTyper;
})(TypingFunctionalities || (TypingFunctionalities = {}));
//# sourceMappingURL=text_manipulating.js.map